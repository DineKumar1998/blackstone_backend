...
import {newService,productFetchData,serviceEditFetch} from "../../appRedux/actions";
//const { Option } = Select;
...
const Registration = (props) => {
  ...
  useEffect(() => {
    ...
    if(inputProduct== '' && serviceEdit!=''){
        console.log(serviceEdit.Product)
        setInputList(serviceEdit.Product);
        setinputProduct('yes')
    }
    if(productAll === ''){
  ...
  return (
    <Card className="gx-card" title="Service Edit Form">
      {(serviceEdit !=='')?
    <Form
      {...formItemLayout}
      form={form}
    ...
    >
      <Form.Item
        name="ServiceName"
        label="Service Name"
        initialValue={(serviceEdit !=='')?serviceEdit.ServiceName:''}
        rules={[
 ...
 <Select
    ...
    productAll.result.map((product, index) => (
      ...
      <Form.Item
        name="Amount"
        label="Amount"
        initialValue={(serviceEdit !=='')?serviceEdit.Amount:''}
     ...
     <Form.Item
        ...
        initialValue={(serviceEdit !=='')?serviceEdit.Duration:''}
      ...
      >
       ...
       {/*<Form.Item label="Service Duration">
        <Form.Item name="Duration" noStyle initialValue={(serviceEdit !=='')?serviceEdit.Duration:''} rules={[{ required: true, message: 'Please enter the Duration of this service!' }]}>
          <InputNumber min={1} max={15} style={{color:'#000'}} />
        </Form.Item>
        <span className="ant-form-text"> Hour</span>
      </Form.Item>*/}
      <Form.Item name="Room"  label="Room needed" valuePropName="checked">
        <Switch defaultChecked={(serviceEdit.Room == 1?true:false)} />
      </Form.Item>
      <Form.Item
        name="Short_Description"
        label="Short Description"
        initialValue={(serviceEdit !=='')?serviceEdit.Short_Description:''}
      ...
      <Form.Item
        ...
        initialValue={(serviceEdit !=='')?serviceEdit.Long_Description:''}
       >
        <TextArea rows={4}  style={{ width: '100%' }} placeholder="Please enter Long Description"  />
      </Form.Item>
      <Form.Item
      ...
      >
        ...
        {inputImage.length<1?
          ...
          {(serviceEdit !=='' && inputImage === '')?<img alt="..." src={serviceEdit.Image} className=""/>:false}
        </Upload>
      </Form.Item>
