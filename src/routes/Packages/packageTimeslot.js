...
import {newtimeSlot,getTimeList,deleteTimeslot,packageEditFetch} from "../../appRedux/actions";
...
const Registration = (props) => {
  ...
  if(TimeListArray === ''){
      ...
      dispatch(getTimeList(props.match.params.Id,'package'));
  ...
  const onFinish = values => {
    ...
    dispatch(newtimeSlot(Time,Id,'package'));
  ...
  return (
    ...
    <InfoView/>
    <h3 style={{textAlign:'center',color:'#DFC15E'}}>{(packageEdit !=='')?packageEdit.PackageName:''}</h3>
