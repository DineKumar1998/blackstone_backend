...
const Title = () => {
 ...
 const pinnedData = [
  ...
  return (
      ...
      <Card className="gx-card" title={"THIS YEAR SALES REPORT"}>
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.current_year_sales}
             bordered
             title={false}
             
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_ThisYear_Reports",btnProps: {
              type: "primary",
              icon:false,
             ...
             summary={pageData => {
              ...
              return (
                  ...
                  <td class="ant-table-cell"><p style={{color:'#f9813a'}}>{(DashBoard!='')?DashBoard.current_year_sales:0} SAR</p></td>
                  <td class="ant-table-cell"></td>
                  <td class="ant-table-cell"></td>
    </tr>
