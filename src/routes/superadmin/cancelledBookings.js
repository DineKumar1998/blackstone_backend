...
import {branchBookings,deleteBooking,bookingRest,serviceListData, ResetSaved, CancelledBookings} from "../../appRedux/actions";
...
const Title = () => {
  ...
  if(BookingList === ''){
      dispatch(CancelledBookings(msearch));
 ...
 // setCount('called')
  ...
  const onFinish = values => {
   ...
   setLoading(true);
   dispatch(CancelledBookings(values.mobilenumber));
    setTimeout(() => {
      setLoading(false);
