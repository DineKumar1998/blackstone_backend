...
const Title = () => {
 ...
 const pinnedData = [
  ...
  return (
      ...
      <Card className="gx-card" title={"LAST WEEK SALES REPORT"}>
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.last_week_sales}
             bordered
             title={false}
             
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_lastweek_Reports",btnProps: {
              type: "primary",
              icon:false,
             ...
             summary={pageData => {
              ...
              return (
                  ...
                  <td class="ant-table-cell"><p style={{color:'#f9813a'}}>{(DashBoard!='')?DashBoard.last_week_sales:0} SAR</p></td>
                  <td class="ant-table-cell"></td>
                  <td class="ant-table-cell"></td>
    </tr>
