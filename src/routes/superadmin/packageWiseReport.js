 ...
 // setCount('called')
  ...
  return (
    <div className="ant-card ant-card-bordered" >
      <Card className="gx-card" title={"PACKAGE WISE RESULT"}>
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.PackageResult}
             bordered
             title={false}
             
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_Package_wise_Reports",btnProps: {
              type: "primary",
              icon:false,
