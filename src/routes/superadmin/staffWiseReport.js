 ...
 // setCount('called')
  ...
  return (
    <div className="ant-card ant-card-bordered" >
      <Card className="gx-card" title={"STAFF WISE BOOKINGS REPORT"}>
       <Form
      {...formItemLayout}
      form={form}
      name="register"
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.StaffResult}
             bordered
             title={false}
             
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_Staff_wise_Reports",btnProps: {
              type: "primary",
              icon:false,
