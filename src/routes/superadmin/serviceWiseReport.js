 ...
 // setCount('called')
  ...
  return (
    <div className="ant-card ant-card-bordered" >
      <Card className="gx-card" title={"SERVICE WISE RESULT"}>
      {/* <Form
      {...formItemLayout}
      form={form}
      name="register"
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.ServiceResult}
             bordered
             title={false}
             pagination={{ pageSize: 25 }}
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_Service_wise_Reports",btnProps: {
              type: "primary",
              icon:false,
