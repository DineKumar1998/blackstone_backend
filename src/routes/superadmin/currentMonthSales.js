...
const Title = () => {
 ...
 const pinnedData = [
  ...
  return (
      ...
      <Card className="gx-card" title={"THIS MONTH SALES REPORT"}>
    ...
    <Card title="">
      ...
      <Table className="gx-table-responsive"
             columns={columns}
             dataSource={BookingList.current_month_sales}
             bordered
             title={false}
             
            // footer={false}
             exportableProps={{ showColumnPicker: false,fileName: "Black_Stones_CurrentMonth_Reports",btnProps: {
              type: "primary",
              icon:false,
             ...
             summary={pageData => {
              ...
              return (
                  ...
                  <td class="ant-table-cell"><p style={{color:'#f9813a'}}>{(DashBoard!='')?DashBoard.current_month_sales:0} SAR</p></td>
                  <td class="ant-table-cell"></td>
                  <td class="ant-table-cell"></td>
    </tr>
