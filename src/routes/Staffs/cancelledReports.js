...
import {branchBookings,deleteBooking,bookingRest,serviceListData, ResetSaved, CancelledBookings,cancelledStaffReport} from "../../appRedux/actions";
...
const Title = () => {
  ...
  if(BookingList === ''){
      dispatch(cancelledStaffReport(msearch));
 ...
 // setCount('called')
  ...
  const onFinish = values => {
   ...
   setLoading(true);
   dispatch(cancelledStaffReport(startDate,endDate));
    setTimeout(() => {
      setLoading(false);
