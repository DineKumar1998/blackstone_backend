...
import {branchBookings,deleteBooking,bookingRest,serviceListData, ResetSaved, CompletedBookings,CompletedBookingStaffReport} from "../../appRedux/actions";
...
const Title = () => {
  ...
  render: (text, record) => (
    <div>
      <p style={{color:"#fff"}}>{record.Paid_Type}</p>
 ...
 const pinnedData = [
  ...
  if(BookingList === ''){
      dispatch(CompletedBookingStaffReport(msearch));
 ...
 // setCount('called')
  ...
  const onFinish = values => {
   ...
   setLoading(true);
   dispatch(CompletedBookingStaffReport(startDate,endDate));
    setTimeout(() => {
      setLoading(false);
  ...
  function refreshall(){
    dispatch(CompletedBookingStaffReport());
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
     //  dispatch(bookingRest());
            ...
            // footer={false}
             ...
             summary={pageData => {
              ...
              return (
                  ...
                  <td class="ant-table-cell"></td>
                  <td class="ant-table-cell"></td>
                  <td class="ant-table-cell"><p style={{color: "#fff"}}>Total Sales</p></td>
